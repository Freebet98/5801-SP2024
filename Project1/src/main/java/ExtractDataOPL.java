...
public class ExtractDataOPL extends ExtractData {
     ...
     * Using this information it places the votes in the location of the party in partyVotes
     * @param partyVotes      this is an ArrayList<ArrayList<Object>> which contains
     *                        inner mappings of a party name and the number of
     *                        corresponding
     *                        votes
     ...
     *                        of their candidates
     * @param candidateName   this is the name of the current candidate whose votes are
     *                        being added to partyVotes
     */
    private void putVotesInPartyVotes(ArrayList<ArrayList<Object>> partyVotes, ArrayList<ArrayList<Object>> candidateVotes, HashMap<String, ArrayList<String>> partyCandidates, String candidateName) {
        String returnKey = "";
