...
public class MPOTests {
	...
	public void testInitializeSeatAllocation() {
    	...
    	// manually compare because assertEquals compares memory addresses for the
    	// int[]s
	...
	public void testBreakTie() {
    	...
    	// test 4.c: numTie is 15, beyond range of number of parties
	...
	public void testAddWinner() throws IOException {
    	...
    	// test 5.a tests to see whether the list is empty on start and if calling it
	...
	public void testAdjustSeatAllocation() throws IOException {
    	...
    	// test 6.a test whether adding a seat at a specified index updates value to 1
    	...
    	// test 6.c test that the same index can be incremented twice      <-- this might be bad
	...
	public void testSeatAllocation() throws IOException {
    	...
    	for(int i=0; i<1000; i++){
        	...
        	// assertEquals(mpo.winOrder.get(0),"D");
	...
	public void testRunElection() throws IOException{
		...
		// test 9.a normal mpo election with one seat to allocate, no ties, 2 parties. 5 candidates
		MPO mpo1 = new MPO(testFile02);
		ResultsData result1 = mpo1.runElection();
